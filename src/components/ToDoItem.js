...
const ToDoItem = ({ todoItem, todoList, setTodoList }) => {
  ...
  return (
    <li className="todoapp-item">
      ...
      <input
        type="checkbox"
        className="todoapp-item-checkbox"
      ...
      />
      {
        ...
        edited ? (
          <input
            type="text"
            className="todoapp-item-edit-input"
            value={newText}
            ref={editInputRef}
            onChange={onChangeEditInput}
            onClick={onClickSubmitButton} //onKeyPress에서 onClick으로 수정*
          />
        ) : (
          <span
            className={`todoapp-item-ctx ${
              todoItem.checked ? "todoapp-item-ctx-checked" : ""
            }`}
          >
            {todoItem.text}
          </span>
      ...
      }
      {
        ...
        !todoItem.checked ? (
          edited ? (
            <button
              type="button"
              className="todoapp-item-edit-btn"
